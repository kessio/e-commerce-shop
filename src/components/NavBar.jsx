...
const NavBar = ({cart}) => {
  ...
  <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
    ...
    <svg className="flex-1 w-8 h-8 fill-current" viewBox="0 0 24 24">
      ...
      {cart.total_items > 0 &&
        <span className="absolute right-2 top-5 lg:top-3 rounded-full bg-red-600 w-4 h-4 top right p-0 m-0 text-white font-mono text-sm  leading-tight text-center">{ cart.total_items}
        </span>
      }

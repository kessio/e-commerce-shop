...
const Product = ({id, name, price, image, addToCart, isLoading}) => {
  return (
    ...
    <button type="button" onClick={() => addToCart(id, 1)} className="flex items-center justify-center w-full px-2 py-2 mt-4 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-gray-800 rounded-md hover:bg-gray-700 focus:outline-none focus:bg-gray-700">
